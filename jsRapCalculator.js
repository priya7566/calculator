...
return this.each(function(){
	...
	var d = $('<div>').appendTo(this);
	AddButton(this,d,'1','calc-button-blue','');
	AddButton(this,d,'2','calc-button-blue','');
	AddButton(this,d,'3','calc-button-blue','');
	AddButton(this,d,'4','calc-button-blue','');
   var d = $('<div>').appendTo(this);
	AddButton(this,d,'5','calc-button-blue','');
	AddButton(this,d,'6','calc-button-blue','');
	AddButton(this,d,'7','calc-button-blue','');
	AddButton(this,d,'8','calc-button-blue','');
   var d = $('<div>').appendTo(this);
	AddButton(this,d,'9','calc-button-blue','');
	AddButton(this,d,'0','calc-button-blue','');
	AddButton(this,d,'.','calc-button-blue','');
	if(this.settings.showHistory)
		this.butEqual = AddButton(this,d,'=','calc-button-brown calc-equal','');
	if(this.settings.showBitwise){
		var d = $('<div>').appendTo(this);
		AddButton(this,d,'EXP','calc-button-purple','Exponentiation');
		AddButton(this,d,'MOD','calc-button-purple','Division Remainder');
